...
| REV-07b | BLOCKER ontológico | PARTIAL | **La generación necesita hiperaridad y productividad real.** | $\operatorname{GenEvent}_i(e_i,A_i,b_i)$. | GE1–GE6 fijan token-specificity, productividad, antecedentes conjuntos, independencia e invariancia. El contraejemplo $\{a,b\}\to c$ demuestra que GenStep binario no preserva closure. Falta justificar qué modos concretos —causal, constitutivo, realización, dependencia, continuidad— satisfacen GE2. |
