...
| REV-20 | BLOCKER | PARTIAL | **K1 ya se deriva constructivamente salvo una condición local de smallness.** | Existencia de extensiones cerradas. | Con StructAdm, OEA y CUA se derivan. Si LSE_i garantiza que todo conjunto de sources genera solo set-many eventos emergentes actuales, el cono de cierre de cualquier dominio set-sized es set-sized y una construcción por rondas finitas produce una extensión E-closed. Falta justificar LSE_i como propiedad del régimen o derivarla de REV-22/fundamentos. |
