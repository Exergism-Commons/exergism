...
| REV-07a | BLOCKER ontológico | PARTIAL | **OriginUnity debe distinguir una base cofundamental de una suma o convergencia sin depender del candidato.** | $\operatorname{UnitFact}_i$ / $\operatorname{EssConDep}_i$ / $\operatorname{ConstitutiveBridge}_i$ / $\operatorname{UnitFoot}_i$. | La forma lógica ya está fijada: cada partición no trivial requiere un ConstitutiveBridge con dependencia constitutiva esencial cruzada hacia ambos lados y footprint interno. OriginConstitutive queda SUPERSEDED; M1–M6 fijan los modelos de control y ECD1–ECD7 el contrato de admisibilidad. Falta instanciar y justificar independientemente una taxonomía de modos ontológicos con cobertura suficiente. |
