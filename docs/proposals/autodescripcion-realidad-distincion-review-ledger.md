...
| REV-07b | BLOCKER ontológico | PARTIAL | **GenEvent debe representar sound/complete una OntProd objetiva y conservar su footprint.** | $\operatorname{OntProd}_i$ / ProdCoverage / CAU-CON-GRD-PRC / $\operatorname{GenFoot}_i$. | OP1–OP8 caracterizan modos objetivos independientes; CAU/CON/GRD/PRC implican OntProd y GenEvent implementa esa taxonomía, por lo que GenSound queda derivado. GenComplete queda exactamente condicionado por ProdCoverage. GF1–GF6 y P1–P8 bloquean soporte omitido/inflado, correlación, enabling, espectadores y pérdida de hiperaridad. Falta justificar ProdCoverage en el contexto usado por ExistsR. |
