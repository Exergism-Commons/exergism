...
| REV-07 | BLOCKER | OPEN | **K3/directedness hace trabajo metaontológico fuerte: dentro del dominio al que se aplica excluye Strong Many-R al exigir una extensión común para cualquier par. Si $\mathfrak D$ se interpreta globalmente, One-R queda en gran parte presupuesto por K3.** | Directedness/amalgamación del régimen; interpretación global del teorema. | Dar un criterio independiente de SameIndex y justificar K3 sin definir «mismo régimen» como «amalgamable». Si K3 solo vale localmente, presentar el teorema como condicional por régimen y no como argumento a favor de One-R global. Para usar K3 globalmente, justificar independently la joint-embeddability de cualesquiera dominios sin presuponer ya que pertenecen a una única realidad total. |
...
| 2026-09-22 | REV-07 | Criterio reforzado: K3 excluye Strong Many-R dentro del régimen y no puede usarse como argumento no circular a favor de One-R global. | Ledger + resumen normativo. | pendiente de este commit |
| 2026-09-22 | REV-21 | Registrada deuda de no-degeneración de $F_M$ en grafos de emergencia ricos; REV-04 permanece cerrado solo en su criterio mínimo. | Ledger + resumen normativo. | pendiente de este commit |
...
Estado sustantivo actual: REV-03, REV-09, REV-18 y REV-19 permanecen PARTIAL; REV-07, REV-08, REV-14, REV-15, REV-20 y REV-21 permanecen OPEN. REV-01, REV-02, REV-04 y REV-10 están RESOLVED en su alcance explícitamente acotado, sin que eso demuestre todavía la ontología global.
