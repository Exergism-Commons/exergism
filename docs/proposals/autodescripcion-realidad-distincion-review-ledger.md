...
| REV-20 | BLOCKER | PARTIAL | **K1 queda caracterizada exactamente por PSB dentro de dominios set-sized con StructAdm + COV.** | Existencia de extensiones cerradas. | Se demuestra $K1_i\iff\mathrm{PSB}_i$: PSB implica K1 mediante cierre por rondas; K1 implica PSB porque una extensión E-closed set-sized que contenga $s$ debe contener todos sus eventos emergentes salientes. La única deuda es justificar/derivar PSB: ningún estado actual es source de proper-class many eventos emergentes actuales. |
