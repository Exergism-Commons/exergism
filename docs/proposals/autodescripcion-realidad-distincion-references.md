...
Para REV-24b estas referencias se usan adversarialmente: Lewis ofrece un modelo claro de worldmate por connectedness pero demasiado específico; Schaffer muestra que apelar al «todo» puede trasladar la carga en vez de resolverla; y la literatura sobre no-separabilidad obliga a comprobar que ninguna unidad física relevante quede invisible para una taxonomía exclusivamente local.
