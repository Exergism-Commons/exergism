...
| REV-07g/07h | PARTIAL global / realizer-coverage bottleneck | IA0 = IA0-R + IA0-U. XR-2 ejecuta una frontera I/O real y ahora descarga UG4 por CIT, UG8 por recodificación y UG6-S por enumeración exhaustiva de la firma finita (27 polaridades, quotient/split, refinements y recoding). `RealizationEnvelope` hace UG5 falsable y separa ordinary/fault/irrelevant variation. La deuda restante se concentra en `RealizerCoverageAdequate`: UG5 y UG6-H exigen cobertura host→firma sin hidden constituents ni protective assumptions. Boundary actuality y signature completeness aún no implican unity sufficiency. Permanecen NQ, InterfaceWall→Muro fuerte y $\Omega_i$. |
