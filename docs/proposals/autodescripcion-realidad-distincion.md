...
| REV-07g/07h | PARTIAL global / IA0-U isolated | IA0 = IA0-R + IA0-U y RSP/εRSP hacia IA0 completo quedan SUPERSEDED. `UnitGroundAdequate` UG1–UG8 se audita en XR-1/Redis/E. coli/Nest. CIT/UnitProfileBreak elimina la circularidad de UG4 y XR-1 lo descarga; el script cierra además una clase finita de rivales FR1–FR4. UG6 sigue PARTIAL porque un DTS desnudo no demuestra `RivalClassCompleteness` (RCC4/RCC5): falta una teoría independiente de interfaz/componente. Redis/E. coli/Nest conservan UG4–UG6 parciales. Permanecen NQ, InterfaceWall→Muro fuerte y $\Omega_i$. |
