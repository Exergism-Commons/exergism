...
| REV-07g/07h | PARTIAL global / IA0-U isolated | ContextIndividuation es objetivo y witness-free. Rival-cut/no-free-promotion y portabilidad SW/BIO/CTRL quedan stress-tested; Redis/E. coli/Nest aportan evidencia concreta. IA0 se separa ahora en IA0-R (realized modal support) e IA0-U (individuation relevance). RSP/εRSP hacia IA0 completo quedan SUPERSEDED; `UnitGroundAdequate` UG1–UG8 es la deuda explícita para pasar de estructura real a unidad contextual. Permanecen NQ, InterfaceWall→Muro fuerte y $\Omega_i$. |
