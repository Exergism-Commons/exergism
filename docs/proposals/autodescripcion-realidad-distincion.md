...
| REV-07g/07h | PARTIAL global / major subcriteria resolved | ContextIndividuation es objetivo y witness-free; TR-M permite contextos anidados bajo MC1–MC10. RC-T1 + NFP-T1–T4 cierran a nivel de criterio rival-cut discipline y no-free-promotion sin imponer anti-proliferation: equivalence/nesting/overlap/genesis/priority son resoluciones admisibles y packaging solo no basta. Generation/GenSig estratifica genealogía; OR1–OR9 + WitnessCovariance separan realization de evidence. Interface/Memo/Bake/ContinuationProfile/FaithfulContinuation están resueltos a nivel de criterio. Permanecen NQ, InterfaceWall→Muro fuerte y $\Omega_i$. |
