...
| REV-07g/07h | PARTIAL global / major subcriteria resolved | ContextIndividuation es objetivo y witness-free; TR-M permite contextos anidados bajo MC1–MC10. RC-T1 + NFP-T1–T4 cierran rival-cut discipline/no-free-promotion a nivel de criterio. SW-A/BIO-A/PHY-A aplican sin excepciones nuevas el mismo contrato a software, célula y control; DR-T1 establece solo portabilidad de la carga de prueba, no identidad de mecanismo ni existencia empírica de esos contextos. Generation/GenSig estratifica genealogía; OR1–OR9 + WitnessCovariance separan realization de evidence. Permanecen NQ, InterfaceWall→Muro fuerte y $\Omega_i$. |
