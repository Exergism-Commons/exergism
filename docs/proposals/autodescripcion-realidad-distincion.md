...
| REV-07g/07h | PARTIAL global / IA0-U isolated | ContextIndividuation es objetivo y witness-free. IA0 se separa en IA0-R e IA0-U; RSP/εRSP hacia IA0 completo quedan SUPERSEDED. `UnitGroundAdequate` UG1–UG8 se audita ahora sobre XR-1, Redis, E. coli y Nest: ninguno descarga aún todos los guards; la deuda común se concentra en UG4 constitutive sensitivity, UG5 constitutive screening y UG6 rival-cut discrimination. La matriz es epistémica, no un ranking ontológico. Permanecen NQ, InterfaceWall→Muro fuerte y $\Omega_i$. |
